...
enum ArmorState_t
{
	ARMOR_NON, ARMOR_HELMET, ARMOR_KEVLAR, ARMOR_BOTH,
};
...
public:
	...
	bool ApplyKevlar(int Armor = 0, float powerMultiplier = 1.0);
	bool ApplyHelmet(float powerMultiplier = 1.0);
